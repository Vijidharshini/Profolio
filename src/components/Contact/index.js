        ...
        <div className="flex-auto w-80  flex flex-col justify-center text-center items-center  gap-1">
          ...
          <div data-aos={"slide-up"} className="text-center">
            ...
            <div className="text-white flex flex-row gap-7 w-fit mx-auto pt-4">
              <div
                onClick={() =>
                  window.open("https://github.com/Vijidharshini", "_blank")
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/vijaya-lakshmi-a-563b5223a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
                    "_blank"
                  )
                }
              >
            ...
            <div className="mt-6 italic text-sm font-medium text-blue-500 ">
              ...
              <span>2023 Vijayalakshmi A</span>
            </div>
          </div>
        </div>
        <ToastContainer
